...
9. Now from an easily accessible place on your computer (i.e. "My Documents"), create a new folder named name it "Websites" (you can name it whatever you want but we'll use "Websites" for consistency).
